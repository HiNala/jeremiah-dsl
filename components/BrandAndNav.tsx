    ...
    <div className="fixed top-4 left-0 right-0 z-50">
      <div className="w-full px-8 md:px-16">
        <div className="flex items-center justify-between h-12 md:h-14">
          ...
          <Link className="font-sans text-base md:text-lg font-normal text-white/90 tracking-wide hover:text-white transition-colors duration-200" href="/">Home</Link>
          
          <Link className="font-sans text-base md:text-lg font-normal text-white/90 tracking-wide hover:text-white transition-colors duration-200" href="/globe">World</Link>
          
          {/* Center brand (smaller size) - now links to about */}
          <Link href="/about" className={`${rockSalt.className} text-xl md:text-2xl tracking-tight text-white hover:text-white/90 transition-colors duration-200`}>Jeremiah Miller</Link>
